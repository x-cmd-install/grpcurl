...
[![x-cmd/install — grpcurl Code Quality Monitoring Repo Card](https://repo.x-cmd.io/grpcurl.svg)](https://x-cmd.com/install/grpcurl)
...
Total: **9,659** lines of code across **37** files in the top 5 languages.
...
- **Upstream**: <https://github.com/fullstorydev/grpcurl>
...
- **Stars**: 12,818 · **Forks**: 580 · **Open issues**: 282 · **Contributors**: 73

## Totals (cumulative)

- **Releases**: 28 · **Merged PRs**: 227 · **Open PRs**: 11 · **Closed issues**: 175 · **Open issues**: 107 · **Commits**: 251
...
_Snapshot: `data/card/260921.yml` · 2026-09-21T05:05:03Z._
